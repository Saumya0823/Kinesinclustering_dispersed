...
c	open(unit=21,file="Rate_diff_V_cluster_N4_D1.dat")
c        open(unit=23,file="V_diff_cluster_N4_D1.dat")
        open(unit=20, file="V_confare_motran_D1_N10.dat")
        open(unit=22, file="V_avgarea_motran_D1_N10.dat")
...
c                end if
     ...
     1          tk_time,"V=",velocity,"T=",tk_time,itime
...
c         tavg_SEM= tavg_SD/sqrt(sigconf2)
     ...
     1          stpsq_avg,Xavgsq,tavg_sq,vel_sqavg,Actsq_avg
