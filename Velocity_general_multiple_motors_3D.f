...
c	open(unit=21,file="Rate_dynam_diff_V_N4_D1.dat")
c        open(unit=23,file="V_dynam_diff_N4_D1.dat")
        open(unit=20, file="V_confare_dynam_D1_N10.dat")
        open(unit=22, file="V_avgarea_dynam_D1_N10.dat")
        open(unit=24, file="V_clus_rate_dynam_D1_N10.dat")
