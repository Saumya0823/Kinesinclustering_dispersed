	Program ratiorates
	open(unit=21, file= "Rate_diff_V_cluster_N10_D001.dat")
        open(unit=22, file= "Rate_diff_V_cluster_N10_D01.dat")
        open(unit=24, file= "Rate_diff_V_cluster_N10_D1.dat")
	open(unit=23, file= "ratios_rates_ranmot_V_N10_F0.dat")
