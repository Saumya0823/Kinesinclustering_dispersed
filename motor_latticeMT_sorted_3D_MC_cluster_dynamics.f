	...
	dimension beadmotx(N),beadmoty(N),beadmotz(N),store_dx(4),
     ...
     1		taual3(N),sum_motin(500),iterm(500),agl(N),
     1          avg_area(500),sm_area(500),poly_x(N),poly_y(N)
	dimension thetamot(N),phimot(N),range(N),avg_motin(500),
...
c        open(unit=10,file="Torque_rand_diff_N10_d001.dat")
c        open(unit=11,file="angle_rand_diff_N10_d001.dat")
c        open(unit=22,file="Rate_rand_latticeMT_N10_d001.dat")
c        open(unit=23,file="RLV_rand_latticeMT_N10_d001.dat")
        open(unit=20, file="motor_tails_ran_D1_N10.dat")
	open(unit=21, file="time_points_ran_D1_N10.dat")
...
c	 do i= 1,50
c	    avg_motin(i)= sum_motin(i)								!/sigconf
c	    print*, -F_ext, i,"avg inter-motor dist=", avg_motin(i)
c            write(20,*) -F_ext,i*0.2, avg_motin(i)
c	 end do
