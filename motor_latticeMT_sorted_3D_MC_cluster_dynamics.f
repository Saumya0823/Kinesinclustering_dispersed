...
c        open(unit=10,file="Torque_DC_diff_N10_D001.dat")
c        open(unit=11,file="angle_DC_diff_N10_D001.dat")
c        open(unit=22,file="Rate_DC_latticeMT_N10_D001.dat")
c        open(unit=23,file="RLV_DC_latticeMT_N10_D001.dat")
        open(unit=20, file="motor_tails_direct_D001_N10_F0.dat")
        open(unit=21, file="time_points_direct_D001_N10_F0.dat")
     ...
     1          tk_time,"V=",velocity,"T=",time
                if(sigconf== maxconf)then
                 do i=1,1000
                   ...
                   write(21,*)-F_ext,vmot,N,i,iterm(i),
