	program readtimetails
        open(unit=20, file="motor_tails_motran_D1_N10.dat")
        open(unit=10, file="tail_t02_D1_N10.dat")
        open(unit=11, file="tail_t2_D1_N10.dat")
	...
	do i=1,5356
	 ...
	 if(time==0.200008288)then
	  ...
	  write(10,*)a,F_ext,N,vmot,sigconf,time,total_area,sum_x
         ...
         if(time==2.00000501)then									!2.00000501)then
	  b= b+1
