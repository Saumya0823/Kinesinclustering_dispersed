	...
	open(unit=23,file="RLV_rand_latticeMT_N5_d1.dat")
	open(unit=24,file="V_rand_diff_N5_D1.dat")
	open(unit=25, file="coop_rand_diff_N5_D1.dat")
...
c	print*, variable
	...
	print*, s,Rad,RL,V,th_V,V_frac,t,tmot,coop
	write(25,*) s,j,k,Rad,RL,V,th_V,V_frac,t,tmot,coop
	end do
	close(23)
	close(24)
	close(25)
